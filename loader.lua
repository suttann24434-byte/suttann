...
--// Features: Key System (1 device/key), Intro GUI + Sound, FPS Boost
...
-- Jalankan script utama jika HWID sudah tersimpan
if HasAccess() then
    RunMainScript()
